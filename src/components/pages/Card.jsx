  ...
  return (
    <>
      ...
      <Card className=" text-warning d-flex">
        <h3 id="home" className={style.home}>Pão de queijo Carioca</h3>
        <Card.Img src={logo} id="logo" className= {style.logo}  alt="logo image" roundedCircle />
        <h3 className={style.about} id="about">Sobre nós</h3>
        <Col xs={6} md={4} className='second' >
          <Image src={foto} className={style.foto} roundedCircle />
        </Col>
        ...
        <div id="aboutme" className={style.aboutme}>
          <main className={style.aboutme}>
            ...
            <Fade in={open}>
              <div className={style.example_fade_text}>
